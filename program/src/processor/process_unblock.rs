...
pub fn process_unblock(
    ...
    if user_account_object.blocked_amount < amount {
        msg!("The given amount is greater than the blocked amount");
    ...
    msg!("Unblocked {}. Updated user account [id={}, balance={}, blocked_amount={}]", 
